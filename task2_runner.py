...
def main():
    ...
    if len(sweep_params['p']) == 0:
       #p_array = gen_p_array()
       p_array = np.linspace(0.51,1,50)
       #p_array = np.linspace(0.11,0.2,10) # will be generated by i*0.01 algorithm internally with guaranteed start and end point
       #print(p_array)
       #exit()
    else:
        print("Using p parameters from config")
